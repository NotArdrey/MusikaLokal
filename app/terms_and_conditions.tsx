    ...
    <View className="flex-1 bg-white px-6">
      ...
      <ScrollView showsVerticalScrollIndicator={false} className="pb-24">
        <View className="pt-6">
          ...
          <Text style={{ fontFamily: 'Poppins_400Regular', fontSize: 14, color: '#374151', lineHeight: 22, textAlign: 'justify', marginTop: 12 }}>
          ...
          <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 16, color: '#000', marginTop: 20, marginBottom: 8 }}>
            Booking & Payments
          </Text>
          ...
          <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 14, color: '#000', marginTop: 12, marginBottom: 4 }}>
            Venues & Musicians
          </Text>
          ...
          <Text style={{ fontFamily: 'Poppins_400Regular', fontSize: 14, color: '#374151', lineHeight: 22, textAlign: 'justify', marginTop: 8 }}>
            Musician cancels:{'\n'}
            • 3 days: 100% refund.{'\n'}
          ...
          <Text style={{ fontFamily: 'Poppins_400Regular', fontSize: 14, color: '#374151', lineHeight: 22, textAlign: 'justify', marginBottom: 20 }}>
