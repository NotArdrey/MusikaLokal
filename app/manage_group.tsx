        ...
        <View className="flex flex-1 mt-3 flex-col">
          ...
          <View className="flex flex-row gap-5 mt-8 justify-center" style={{ borderBottomWidth: 1, borderBottomColor: colors.border }}>
            ...
            <TouchableOpacity onPress={() => {setActiveTab('Gigs')}}>
              <Text className="pb-2" style={{ fontFamily: activeTab === 'Gigs'? 'Poppins_600SemiBold': 'Poppins_500Medium', fontSize: 15, color: colors.text, borderBottomWidth: 1, borderBottomColor: colors.border  }}>Gigs</Text>
            </TouchableOpacity>
          ...
          {activeTab ==='About'? (
            <View className="flex flex-1 flex-col mt-4">
              ...
              <View className="mt-5 flex pt-3" style={{ borderTopWidth: 1, borderTopColor: colors.border }}>
                <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 16, color: colors.text }}>Manager</Text>
                
                <View className="flex-row items-center justify-between">
                  <View className="flex-col">
                    <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 14, color: colors.text }}>Jared Cariaso</Text>
            ...
            <View className="flex flex-1 flex-col mt-4">
              <View>
                <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 15, color: colors.text }}>Gig Invitations</Text>
                <Text style={{ fontFamily: 'Poppins_400Regular', fontSize: 13, color: colors.textSecondary, marginTop: 4 }}>Venues and event organizers inviting your group to perform</Text>
              </View>
              ...
              <View className="rounded-xl p-4 mt-4" style={{ borderWidth: 1, borderColor: colors.border }}>
                <View className="flex-row items-center justify-between">
                  <View className="flex-row items-center gap-3 flex-1">
                    <View className="rounded-xl overflow-hidden" style={{height: 60, width: 60, borderWidth: 1, borderColor: colors.border}}>
                      <Image
                    ...
                    <View className="flex-1">
                      <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 15, color: colors.text }}>The Blue Note Bar</Text>
                      <Text style={{ fontFamily: 'Poppins_400Regular', fontSize: 13, color: colors.textSecondary }}>Live Music Venue • Makati City</Text>
                      <View className="flex-row items-center mt-1">
                        <Ionicons name="star" size={14} color={colors.primary} />
                        <Text style={{ fontFamily: 'Poppins_500Medium', fontSize: 12, marginLeft: 4, color: colors.text }}>4.9 (156 reviews)</Text>
                      </View>
                    </View>
                  </View>
                </View>
                ...
                <View className="mt-3 bg-primary-50 rounded-lg p-3">
                  <View className="flex-row items-center gap-2">
                    ...
                    <Text style={{ fontFamily: 'Poppins_500Medium', fontSize: 13, color: colors.primary }}>Dec 22, 2025 • 8:00 PM - 11:00 PM</Text>
                  </View>
                  <View className="flex-row items-center gap-2 mt-1">
                    <Ionicons name="cash-outline" size={16} color={colors.primary} />
                    <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 13, color: colors.primary }}>₱8,000.00</Text>
                  </View>
                </View>
                
                <View className="mt-3">
                  <Text style={{ fontFamily: 'Poppins_400Regular', fontSize: 13, color: colors.textSecondary }}>"We loved your performance at our sister venue! Would you be interested in a 3-hour set for our Christmas event? We'll provide all sound equipment."</Text>
                </View>
              ...
              <View className="rounded-xl p-4 mt-3" style={{ borderWidth: 1, borderColor: colors.border }}>
                <View className="flex-row items-center justify-between">
                  <View className="flex-row items-center gap-3 flex-1">
                    ...
                    <View className="flex-1">
                      <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 15, color: colors.text }}>Sunset Beach Resort</Text>
                      <Text style={{ fontFamily: 'Poppins_400Regular', fontSize: 13, color: colors.textSecondary }}>Resort • Batangas</Text>
                      <View className="flex-row items-center mt-1">
                        <Ionicons name="star" size={14} color={colors.primary} />
                        <Text style={{ fontFamily: 'Poppins_500Medium', fontSize: 12, marginLeft: 4, color: colors.text }}>4.7 (89 reviews)</Text>
                      </View>
                    </View>
                  </View>
                </View>
                ...
                <View className="mt-3 bg-primary-50 rounded-lg p-3">
                  <View className="flex-row items-center gap-2">
                    <Ionicons name="calendar" size={16} color={colors.primary} />
                    <Text style={{ fontFamily: 'Poppins_500Medium', fontSize: 13, color: colors.primary }}>Dec 31, 2025 • 9:00 PM - 1:00 AM</Text>
                  </View>
                  <View className="flex-row items-center gap-2 mt-1">
                    <Ionicons name="cash-outline" size={16} color={colors.primary} />
                    <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 13, color: colors.primary }}>₱15,000.00</Text>
                  </View>
                </View>
                
                <View className="mt-3">
                  <Text style={{ fontFamily: 'Poppins_400Regular', fontSize: 13, color: colors.textSecondary }}>"We're hosting a New Year's Eve countdown party and would love to have your band headline the event. Accommodation and meals included!"</Text>
                </View>
              ...
              <View className="rounded-xl p-4 mt-3" style={{ borderWidth: 1, borderColor: colors.border }}>
                <View className="flex-row items-center justify-between">
                  <View className="flex-row items-center gap-3 flex-1">
                    ...
                    <View className="flex-1">
                      <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 15, color: colors.text }}>Corporate Events PH</Text>
                      <Text style={{ fontFamily: 'Poppins_400Regular', fontSize: 13, color: colors.textSecondary }}>Event Organizer • BGC, Taguig</Text>
                      <View className="flex-row items-center mt-1">
                        <Ionicons name="star" size={14} color={colors.primary} />
                        <Text style={{ fontFamily: 'Poppins_500Medium', fontSize: 12, marginLeft: 4, color: colors.text }}>4.8 (67 reviews)</Text>
                      </View>
                    </View>
                  </View>
                </View>
                ...
                <View className="mt-3 bg-primary-50 rounded-lg p-3">
                  <View className="flex-row items-center gap-2">
                    <Ionicons name="calendar" size={16} color={colors.primary} />
                    <Text style={{ fontFamily: 'Poppins_500Medium', fontSize: 13, color: colors.primary }}>Jan 15, 2026 • 6:00 PM - 9:00 PM</Text>
                  </View>
                  <View className="flex-row items-center gap-2 mt-1">
                    <Ionicons name="cash-outline" size={16} color={colors.primary} />
                    <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 13, color: colors.primary }}>₱12,000.00</Text>
                  </View>
                </View>
                
                <View className="mt-3">
                  <Text style={{ fontFamily: 'Poppins_400Regular', fontSize: 13, color: colors.textSecondary }}>"We're organizing an annual company dinner for 300 guests and are looking for live entertainment. Interested in a 3-hour acoustic set?"</Text>
                </View>
