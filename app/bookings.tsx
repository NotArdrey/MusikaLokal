...
export default function BookingsScreen() {
  ...
  async function fetchBookings(targetUserId: string) {
    try {
      ...
      const applicants = rawPending.filter(
    ...
    try {
      ...
      if (error) {
        ...
        if (response?.error) {
          ...
          Alert.alert(
            "Check-In Failed",
            "Could not verify booking. Please try again.",
          );
        }
        return;
      }
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <View style={{ flex: 1 }}>
                        {isMusicianView ? (
                          // Musician viewing their own application - show gig name
                          <>
                            <TouchableOpacity
                          ...
                          // Venue owner viewing applicants - show applicant name
                          <>
                            <TouchableOpacity
                              onPress={() => handleDetailsPress(item)}
                            >
                    ...
                    {/* Location & Date Info for Musicians */}
                    {isMusicianView && (
                      <View
                        style={{
                          flexDirection: "row",
