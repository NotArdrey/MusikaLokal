        ...
        <View className="flex flex-1 flex-col justify-between gap-1 mt-3">
          <View className="flex flex-1 flex-row justify-between items-center px-3 rounded-xl" style={{
            ...
            <View className="flex justify-between gap-2 py-4"> 
              ...
              <TouchableOpacity className="bg-gray-200 rounded-lg px-4 py-2 flex-1 flex-row gap-1 justify-center items-center">
                <Text style={{fontFamily: 'Poppins_400Regular', fontSize: 12}}>Awaiting Confirmation</Text>
          ...
          <View className="flex flex-1 flex-row justify-between items-center px-3 rounded-xl" style={{
            ...
            <View className="flex justify-between gap-2"> 
              ...
              <TouchableOpacity className="bg-green-600 rounded-lg px-4 py-2 flex-1 flex-row gap-1 justify-center items-center">
                <Text style={{fontFamily: 'Poppins_600SemiBold', fontSize: 12, color: '#fff'}}>Confirm</Text>
                <Ionicons name="checkmark-sharp" size={15} color="#fff" style={{fontWeight: 'bold'}} />
              </TouchableOpacity>
            </View>
