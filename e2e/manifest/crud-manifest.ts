...
export const crudManifest: CrudManifestEntry[] = [
  ...
  { app: 'admin-web', domain: 'studios', operation: 'create', status: 'ui', table: 'studios' },
  { app: 'admin-web', domain: 'studios', operation: 'read', status: 'ui', table: 'studios' },
  { app: 'admin-web', domain: 'studios', operation: 'update', status: 'ui', table: 'studios' },
  { app: 'admin-web', domain: 'studios', operation: 'delete', status: 'ui', table: 'studios' },
  { app: 'admin-web', domain: 'venues', operation: 'create', status: 'ui', table: 'gigs' },
  { app: 'admin-web', domain: 'venues', operation: 'read', status: 'ui', table: 'gigs' },
  { app: 'admin-web', domain: 'venues', operation: 'update', status: 'ui', table: 'gigs' },
  { app: 'admin-web', domain: 'venues', operation: 'delete', status: 'ui', table: 'gigs' },
  { app: 'admin-web', domain: 'production teams', operation: 'create', status: 'ui', table: 'production_teams' },
  { app: 'admin-web', domain: 'production teams', operation: 'read', status: 'ui', table: 'production_teams' },
  { app: 'admin-web', domain: 'production teams', operation: 'update', status: 'ui', table: 'production_teams' },
  { app: 'admin-web', domain: 'production teams', operation: 'delete', status: 'ui', table: 'production_teams' },
  { app: 'admin-web', domain: 'studio booking activity', operation: 'read', status: 'ui', table: 'studio_bookings' },
  { app: 'admin-web', domain: 'studio booking activity', operation: 'status', status: 'ui', table: 'studio_bookings' },
  { app: 'admin-web', domain: 'gig application activity', operation: 'read', status: 'ui', table: 'gig_applications' },
  { app: 'admin-web', domain: 'gig application activity', operation: 'status', status: 'ui', table: 'gig_applications' },
  { app: 'admin-web', domain: 'listing request activity', operation: 'read', status: 'ui', table: 'booking_requests' },
  { app: 'admin-web', domain: 'listing request activity', operation: 'status', status: 'ui', table: 'booking_requests' },
  ...
  { app: 'mobile', domain: 'social feed', operation: 'create', status: 'ui', table: 'feed_posts', notes: 'Feed composer supports signed-in fan and creator accounts through the moderated manage-social-feed path.' },
