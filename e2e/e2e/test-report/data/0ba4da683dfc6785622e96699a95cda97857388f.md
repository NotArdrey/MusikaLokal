...
- Name: mobile\social-posting.spec.ts >> mobile social posting >> creates feed posts as a creator and fan
- Location: e2e\tests\mobile\social-posting.spec.ts:20:7

# Error details

```
Error: Maestro flow failed: mobile-feed-create-post.yaml
...
E:\React-Native-Projects\MusikaLokal>"C:\Program Files\Microsoft\jdk-17.0.18.8-hotspot/bin/java.exe"     -classpath "C:\Users\kngtr\AppData\Local\Programs\maestro-cli\cli-2.5.1\maestro\lib\*" maestro.cli.AppKt "test" "-e" "APP_ID=com.anonymous.musikalokal" "-e" "E2E_ADMIN_EMAIL=e2e+admin@musikalokal.test" "-e" "E2E_ADMIN_PASSWORD=E2E-password-123" "-e" "E2E_POST_CONTENT=MobilePoste2e1779213581227mobilesocialpost" "E:\React-Native-Projects\MusikaLokal\e2e\maestro\mobile-feed-create-post.yaml" 
Running on Medium_Phone_API_36.1
 > Flow mobile-feed-create-post
Open musikalokal://feed... COMPLETED
Assert that id: mobile-feed-create-post-button is visible... FAILED

Assertion is false: id: mobile-feed-create-post-button is visible

Assertion 'id: mobile-feed-create-post-button is visible' failed. Check the UI hierarchy in debug artifacts to verify the element state and properties.
...
C:\Users\kngtr\.maestro\tests\2026-05-20_020628
...
Command failed: call maestro.bat "test" "-e" "APP_ID=com.anonymous.musikalokal" "-e" "E2E_ADMIN_EMAIL=e2e+admin@musikalokal.test" "-e" "E2E_ADMIN_PASSWORD=E2E-password-123" "-e" "E2E_POST_CONTENT=MobilePoste2e1779213581227mobilesocialpost" "E:\React-Native-Projects\MusikaLokal\e2e\maestro\mobile-feed-create-post.yaml"
