-- Safe studio deletion flow with booking guards, audit trail, and storage cleanup.
...
BEGIN
  ...
  IF v_studio.images IS NOT NULL THEN
    v_storage_urls := v_storage_urls || v_studio.images;
  END IF;
