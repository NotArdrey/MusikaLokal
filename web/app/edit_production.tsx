...
export default function EditProductionScreen() {
  ...
  const fetchTeam = useCallback(async () => {
    ...
    try {
      ...
      if (
        ...
        throw new Error('Only team owners, managers, or staff with Edit listing permission can edit this production team.');
      }
  ...
  useEffect(() => {
    if (userRole && userRole !== 'producer' && userRole !== 'staff') {
      setAlert({ type: 'warning', title: 'Production Only', message: 'Only production users or staff with Edit listing permission can edit production teams.' });
  ...
  return (
    <View style={[styles.container, { backgroundColor: pageBackground }]}>
      <Header title="Edit Production" cardStyle onBackPress={() => router.replace('/manage')} />
