                  ...
                  >
                    ...
                    <View style={styles.unpaidInfo}>
                      ...
                      <Text style={styles.unpaidDate}>
                        {formatDashedNumericDate(booking.booking_date)} • {booking.start_time?.slice(0, 5)}
                      </Text>
                    ...
                    <View style={styles.withdrawalLeft}>
                      ...
                      <View style={{ flex: 1 }}>
                        ...
                        <Text style={[styles.transactionDate, { color: colors.textSecondary }]}>
                          {formatDashedNumericDate(withdrawal.created_at)} • ****{withdrawal.payout_account_number.slice(-4)}
                        </Text>
                      </View>
                    </View>
