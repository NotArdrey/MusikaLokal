...
export const generateOfflineSuggestionsWithLocalLLM = async (
  ...
  if (!runtime) {
    return {
      ...
      aiProvider: "On-Device LLM",
      message:
        "On-device LLM runtime is not installed on this web build. Suggestions require the local LLM runtime.",
    };
  }
  ...
  try {
    ...
    return {
      ...
      aiPowered: false,
      aiProvider: "On-Device LLM",
      message: "On-device LLM timed out. No local-ranking fallback is enabled.",
    };
  }
};
