            ...
            <>
              ...
              {(studioDetails || isGig) && (
                ...
                >
                  ...
                  <View style={styles.studioInfo}>
                    ...
                    {isGig && booking.customer_name && (
                      <View style={styles.ownerRow}>
                        ...
                        <View style={{ flex: 1 }}>
                          ...
                          {/* Show if group or solo application */}
                          <Text
                            style={[
                              styles.ownerName,
                              {
                    ...
                    {/* Applied As - Group or Solo (for musicians viewing their own application) */}
                    {isGig && !booking.customer_name && (
              ...
              {isGig &&
                ...
                booking.group_members.length > 0 && (
                  ...
                  >
                    ...
                    <View style={{ gap: 12 }}>
                      {booking.group_members.map(
                        (member: any, index: number) => {
                          const isLeader =
                            member.role === "Leader" || index === 0;
                          const memberName =
                ...
                <View style={styles.detailsGrid}>
                  ...
                  {dateOverride && isStudio && (
                    <View style={styles.detailItem}>
                      ...
                      >
                        Studio Hours (This Day)
                      </Text>
                      <Text style={[styles.detailValue, { color: "#F59E0B" }]}>
                        {formatTime(dateOverride.open_time)} -{" "}
                        {formatTime(dateOverride.close_time)}
                      </Text>
                      {dateOverride.reason && (
                        <Text
                          style={{
              ...
              {booking.total_cost && (
                ...
                >
                  ...
                  {booking.modifiers_applied &&
                    Object.keys(booking.modifiers_applied).length > 0 && (
                      <>
