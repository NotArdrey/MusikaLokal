-- Allow assigned Level 1 venue staff to use the existing safe gig update workflow.
-- This keeps reconfirmation, slot-conflict checks, 3NF sync, and cleanup behavior in one function.
