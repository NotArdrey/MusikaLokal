...
insert into public.groups (id, owner_id, name, genre, description, location, latitude, longitude, rate, group_type, open_group_applications) values
  ...
  ('30000000-0000-4000-8000-000000000003','10000000-0000-4000-8000-000000000001','Cubao Night Market','Alt Rock','Guitar-forward alt-rock crew with 90s OPM covers and two-set bar programs.','Cubao, Quezon City',14.6192,121.0564,22000,'band',true),
  ('30000000-0000-4000-8000-000000000004','10000000-0000-4000-8000-000000000002','Muni Muni Strings','Acoustic OPM','Acoustic duo built for garden weddings, listening rooms, and proposal dinners.','Tagaytay City, Cavite',14.1153,120.9621,14000,'duo',true),
  ('30000000-0000-4000-8000-000000000005','10000000-0000-4000-8000-000000000001','Pasig Brass Club','Soul / Funk','Horn-backed party band for brand launches, city festivals, and late-night dance sets.','Pasig City, Metro Manila',14.5764,121.0851,32000,'band',true)
on conflict (id) do nothing;
...
insert into public.product_variants (product_id, variant_label, variant_type, price_override, sku, stock_quantity, is_available) values
  ...
  ('60000000-0000-4000-8000-000000000002','Digital bundle','format',350,'MRQ-STEMS-DIGI',200,true),
  ('60000000-0000-4000-8000-000000000003','Signed poster','edition',450,'SD-POSTER-SIGNED',75,true),
  ('60000000-0000-4000-8000-000000000004','Numbered zine','edition',520,'MR-ZINE-NUM',60,true),
...
insert into public.playlist_items (id, playlist_id, title, artist_name, duration_seconds, "position", audio_url) values
  ...
  ('a1000000-0000-4000-8000-000000000002','a0000000-0000-4000-8000-000000000002','Late Jeepney Bossa','Mara Reyes Quartet',204,0,'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3'),
  ...
  ('a1000000-0000-4000-8000-000000000004','a0000000-0000-4000-8000-000000000004','Aurora Pedalboard','Cubao Night Market',246,0,'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3'),
...
insert into public.gig_applications (
  ...
  ('92000000-0000-4000-8000-000000000003','10000000-0000-4000-8000-000000000005','30000000-0000-4000-8000-000000000002','40000000-0000-4000-8000-000000000001','Escolta Audio Bureau can coordinate Mara Reyes Quartet with backline, call sheets, and settlement handled by the production team.','https://www.youtube.com/watch?v=9bZkp7q19f0','pending','https://musikalokal.app/press/escolta-audio-roster.pdf',false,'band','10000000-0000-4000-8000-000000000005',null,null,'90000000-0000-4000-8000-000000000002','91000000-0000-4000-8000-000000000002','Production team application with roster details.'),
  ('92000000-0000-4000-8000-000000000004','10000000-0000-4000-8000-000000000001','30000000-0000-4000-8000-000000000003','40000000-0000-4000-8000-000000000005','Cubao Night Market can deliver a tight 30-minute opener with a clean corporate set list.','https://www.youtube.com/watch?v=3JZ_D3ELwOQ','approved','https://musikalokal.app/press/cubao-night-market.pdf',false,'band','10000000-0000-4000-8000-000000000001','approved',timezone('utc'::text, now()),null,null,'Approved band application for upcoming activity.'),
