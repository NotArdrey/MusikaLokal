...
BEGIN
    ...
    INSERT INTO public.profiles (id, email, full_name, role, location, avatar_url, verification_status, is_verified)
    VALUES 
        (user1_id, 'musician@tet.com', 'Musician User', 'musician', 'Quezon City', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&fit=crop', 'APPROVED', true),
        (user2_id, 'studio@test.com', 'Studio Owner User', 'studio-owner', 'Makati City', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&fit=crop', 'APPROVED', true),
        (user3_id, 'manager@test.com', 'Venue Owner', 'venue-owner', 'BGC, Taguig', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&fit=crop', 'APPROVED', true)
    ON CONFLICT (id) DO UPDATE 
    SET full_name = EXCLUDED.full_name, role = EXCLUDED.role, avatar_url = EXCLUDED.avatar_url, email = EXCLUDED.email, verification_status = EXCLUDED.verification_status, is_verified = EXCLUDED.is_verified;
